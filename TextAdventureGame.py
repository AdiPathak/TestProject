...
def barn():
    ...
    if choice == 1:
        print(
            "You walk to the horses and feed them. They are very excited to see you. You start petting them and they really seem to like it.")
...
def lake():
    ...
    if choice == 1:
        print("You let the fish go and it swims back into the lake disappearing ")
